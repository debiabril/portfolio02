...
export const AboutMe = () => {
    return (
        <div className='bg-aboutme w-full min-h-screen max-h-[130vh] bg-cover bg-center flex justify-end sm:justify-center items-center'>
            <div className='flex flex-col mr-5 justify-center items-center w-[70vw] sm:w-[50vw] min-h-screen mb-20 bg-white-100 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-md  bg-opacity-60 h-[100%] text-white'>
